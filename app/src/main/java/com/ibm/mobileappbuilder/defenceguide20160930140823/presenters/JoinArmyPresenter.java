...
public class JoinArmyPresenter extends BasePresenter implements ListCrudPresenter<ArmyDSItem>,
      Datasource.Listener<ArmyDSItem>{

    private final CrudDatasource<ArmyDSItem> crudDatasource;
    private final CrudListView<ArmyDSItem> view;

    public JoinArmyPresenter(CrudDatasource<ArmyDSItem> crudDatasource,
                                         CrudListView<ArmyDSItem> view) {
    ...
    @Override
    public void deleteItems(List<ArmyDSItem> items) {
    ...
    @Override
    public void editForm(ArmyDSItem item, int position) {
        view.showEdit(item, position);
    }

    @Override
    public void detail(ArmyDSItem item, int position) {
